...
export const bountyTable = pgTable('bounties', {
  ...
  communicationMethod: varchar('communication_method', { length: 128 }).default('chat'), // Default communication method
...
export const paymentTable = pgTable('payments', {
  ...
  paymentStatus: varchar('payment_status', { length: 128 }).default('pending').notNull(), // 'pending', 'completed', 'failed'
