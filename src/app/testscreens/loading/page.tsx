  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#303841] bg-opacity-90 backdrop-blur-sm z-50">
      <div className="bg-[#ffffff] p-8 rounded-lg shadow-lg flex flex-col items-center max-w-sm w-full">
        ...
        <h2 className="text-2xl font-bold text-[#303841] mb-4">Loading BountyWise</h2>
        <p className="text-[#46515e] text-center mb-6">Preparing your content...</p>
        <div className="flex justify-center space-x-8 mb-6">
          ...
          <div className="flex flex-col items-center animate-bounce" style={{ animationDelay: '600ms' }}>
        ...
        <div className="w-full bg-[#eeeeee] rounded-full h-2 mb-4">
          <div className="bg-[#ff5722] h-2 rounded-full animate-pulse" style={{ width: '75%' }}></div>
        </div>
